...
const MAKERS = {
  ...
  pixel: {
    ...
    path: "設定 ＞ システム ＞ 開発者向けオプション ＞「OEMロック解除」",
    ok: "スイッチが操作できる ＝ ロックなし",
    ng: "スイッチがグレー＋「携帯通信会社によってロックされている端末では利用できません」＝ ロックあり",
    notes: [
      "開発者向けオプションが無い場合：設定 ＞ デバイス情報 ＞ ビルド番号 を7回タップ",
  ...
  xperia: {
    ...
    path: "設定 ＞ デバイス情報（端末情報）＞ SIMのステータス ＞「SIMロックステータス」",
    ok: "許可されています ＝ 解除済",
    ng: "許可されていません ＝ ロック中",
    notes: [
  ...
  galaxy: {
    ...
    path: "設定 ＞ 端末情報 ＞ ステータス情報 ＞「SIMロックの状態」",
    ok: "許可 ＝ 解除済",
  ...
  aquos: {
    ...
    path: "ドコモ／SB／Y!版：設定 ＞ デバイス情報（端末情報）＞ SIMのステータス",
    pathBy: { au: "設定 ＞ システム ＞ 端末情報 ＞「SIMロックの状態」", uq: "設定 ＞ システム ＞ 端末情報 ＞「SIMロックの状態」" },
    ok: "許可 ＝ 解除済",
    ng: "許可されていません ＝ ロック中",
    notes: [
  ...
  kyocera: {
    ...
    path: "BASIO4：その他の設定 ＞ デバイス情報 ＞「SIMカードの状態」／BASIO3：ツール ＞ 設定 ＞ 端末情報 ＞「SIMカードの状態」",
    ok: "許可 ＝ 解除済",
    ng: "許可されていません ＝ ロック中",
    notes: [
  ...
  oppo: {
    ...
    path: "設定 ＞ 端末情報 ＞ SIMカードのステータス ＞「SIMカードロックステータス」",
    ok: "許可 ＝ 解除済",
    ng: "許可されていません ＝ ロック中",
    notes: [
  ...
  xiaomi: {
    ...
    path: "設定 ＞ デバイス情報 ＞ すべての仕様 ＞ デバイスの状態 ＞「SIMカードのステータス」",
    ok: "許可 ＝ 解除済",
    ng: "許可されていません ＝ ロック中",
    notes: [
      "ロック状態・「SIMのステータス更新」はここ（階層が深いので注意）",
  ...
  huawei: {
    ...
    path: "電話アプリで *#*#2846579#*#* ＞ プロジェクトメニュー ＞ ネットワーク設定 ＞ SIMロック状態照会",
  ...
  android: {
    ...
    path: "設定 ＞ デバイス情報（端末情報）＞ SIMのステータス／機器の状態",
    ok: "許可／解除済 ＝ ロックなし",
    ng: "許可されていません／ロック中 ＝ ロックあり",
    notes: [
      "「SIMロック状態」「SIMロックステータス」などの項目を探す",
      "見つからない場合は設定の検索窓で「SIMロック」と入力",
  ...
  garaho: {
    ...
    path: "メニュー ＞ 設定 ＞ 端末情報（またはその他設定 ＞ 端末情報）",
